...
if selected == "About":
    ...
    with col1:
        st.image('pulse.gif', width=600)

    # Display information about PhonePe in col2
    with col2:
...
if selected == "Home":
    ...
    with col2:
        ...
        st.markdown("### :violet[Done by] : Swapnil Aknurwar")
        st.markdown("[Inspired from](https://www.phonepe.com/pulse/)")
        st.markdown("[Githublink](https://github.com/Deathstroke16)")
        st.markdown("[LinkedIn](https://www.linkedin.com/in/swapnil-aknurwar/)")
    st.write("---")
    ...
    if select == "INDIA":
        ...
        with tab2:
            ...
            fig_use = px.choropleth(
                ...
                color_continuous_scale='viridis', title='User Analysis')
            ...
            df_in_us_tab_qry_rslt1_fig = px.bar(df_in_us_tab_qry_rslt1, x='State', y='User Count', color='User Count',
                                                color_continuous_scale='viridis', title='User Analysis Chart',
                                                height=700, )
    ...
    if select == "TOP CATEGORIES":
        ...
        with tab5:
            ...
            df_top_tr_tab_qry_rslt1_fig = px.bar(df_top_tr_tab_qry_rslt1, x='State', y='Top Transaction amount',
                                                 color='Top Transaction amount', color_continuous_scale='viridis',
        ...
        with tab6:
            ...
            df_top_us_tab_qry_rslt1_fig = px.bar(df_top_us_tab_qry_rslt1, x='State', y='Total User count',
                                                 color='Total User count', color_continuous_scale='viridis',
